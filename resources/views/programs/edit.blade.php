<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between">
            ...
            <Link href=" {{ route('programs.index')}}" class="px-4 py-2 bg-slate-400 hover:bg-slate-600 text-slate-100 rounded-md flex ">
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <x-splade-form :default="$program" method="PUT" :action="route('programs.update',$program->id)" class="p-4 bg-white rounded-md" >
